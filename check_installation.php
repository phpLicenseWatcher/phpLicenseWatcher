...
define("PASS_MARK", "<span style='color: green;'>&#10004; GOOD</span>");  // green heavy checkmark
define("FAIL_MARK", "<span style='color: #dc143c;'>&#10006; MISSING</span>");  // red cross mark
...
<p style="color: #dc143c;">When the script is finished with the check it will print out a congratulation message. If there is no congratulatory message a problem appeared that this script didn't anticipate :-(.</p>
