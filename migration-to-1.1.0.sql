ALTER TABLE flexlm_events rename temp;
...
INSERT INTO flexlm_events SELECT * FROM temp;

ALTER TABLE license_usage RENAME temp2;
...
CREATE TABLE license_usage (
    ...
    PRIMARY KEY (flmusage_product, flmusage_date, flmusage_time)
);

INSERT INTO license_usage SELECT * FROM temp2;

ALTER TABLE licenses_available RENAME temp3;
...
INSERT INTO licenses_available SELECT * FROM temp3;
